...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> employeeNotFound(EmployeeNotExistException enf, WebRequest wRequest){
		MyErrorDetails myErrorDetails=new MyErrorDetails(enf.getMessage(), wRequest.getDescription(false), LocalDateTime.now());
