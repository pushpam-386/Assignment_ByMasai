...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler
	public ResponseEntity<MyErrorDetails> EmployeeExceptionHandler(EmployeeException eexp, WebRequest webRequest){
		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), eexp.getMessage(), webRequest.getDescription(false));
